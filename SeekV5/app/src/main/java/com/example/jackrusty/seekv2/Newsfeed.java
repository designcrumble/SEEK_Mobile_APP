...
public class Newsfeed extends ListActivity {
    ...
    private static String url_all_products = "http://172.22.11.16/androidhive/get_newsfeed_user.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // launching View Report Details Screen
        ...
        btnCreateReport.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                // Launching Create Report activity
